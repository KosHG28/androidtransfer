...
interface TransferSink {
    ...
    suspend fun sendFile(displayName: String, sizeBytes: Long, mimeType: String?, relativePath: String? = null, open: () -> InputStream)
}
...
class CategorySink(private val category: TransferCategory, private val transport: dev.androidtransfer.app.core.transport.P2pTransport) : TransferSink {
    ...
    override suspend fun sendFile(displayName: String, sizeBytes: Long, mimeType: String?, relativePath: String?, open: () -> InputStream) {
